...
function shift_register_config(this_block)
  ...
  % Revision History:
  %
  %   01-Feb-2024  (16:15 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     C:\Users\adiglesias\OneDrive - gradiant.org\Documentos\GitHub\COM-PR-01523-ANTI-JAMMING-II-VitisModelComposer-Tests\src\shift_register.vhd
  %
  %
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('shift_register.vhd');
